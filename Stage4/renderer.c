...
{
    plotBitMap64(base32,player->x,100,snowBoarder,128);
}
...
{
    plotBitMap64(base32,skier->x,skier->y,Skier,128);
}


void renderTree(const Tree *tree, UINT32 *base32)
{
    plotBitMap64(base32,tree->x,tree->y,treeArr,128);
...
void renderLives(const Lives *lives, UINT32 *base32)
{
    ...
    while(count>0)
    {
        plotBitMap32(base32,xCoor,lives->y,heartLife,32);
