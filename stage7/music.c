...
/*
    /*9th bar
    {rest, 28}, {C >> seventh_oct, 14}, {rest, 28}, {C >> seventh_oct, 14}, {rest, 28},

    /*10th bar
    {C >> seventh_oct, 14}, {rest, 28}, {C >> seventh_oct, 14}, 
    {rest, 28}, {G >> sixth_oct, 28}, 

    /*11th bar
    {G >> sixth_oct, 7}, {rest, 21}, {C >> sixth_oct, 14}, {rest, 28}, 
    {A >> fifth_oct, 14}, {rest, 14}, {A >> fifth_oct, 7},
...
/*
    /*9th bar
    {rest, 28}, {A >> sixth_oct, 14}, {rest, 28}, {A >> sixth_oct, 14}, {rest, 28},

    /*10th bar
    {A >> sixth_oct, 14}, {rest, 28}, {A >> sixth_oct, 14}, 
    {rest, 28}, {E >> sixth_oct, 28}, 

    /*11th bar
    {E >> sixth_oct, 7}, {rest, 21}, {A >> fifth_oct, 14}, {rest, 28}, 
    {F >> fifth_oct, 14}, {rest, 14}, {F >> fifth_oct, 7},

    /*12th bar
    {F >> fifth_oct, 14}, {E >> fifth_oct, 14}, {rest, 14}, {D >> fifth_oct, 70},
*/
};
...
/*
    /*9th bar
    {rest, 28}, {F >> sixth_oct, 14}, {rest, 28}, {F >> sixth_oct, 14}, {rest, 28},

    /*10th bar
    {F >> sixth_oct, 14}, {rest, 28}, {F >> sixth_oct, 14}, 
    {rest, 28}, {C >> sixth_oct, 28}, 

    /*11th bar
    {C >> sixth_oct, 7}, {rest, 21}, {F >> fifth_oct, 14}, {rest, 28}, 
    {C >> fifth_oct, 14}, {rest, 14}, {C >> fifth_oct, 7},

    /*12th bar
    {C >> fifth_oct, 14}, {C >> fifth_oct, 14}, {rest, 14}, {C >> fifth_oct, 70},
*/
};
...
Note gameSong[] = 
{
    ...
    */
    ...
    /*1st bar*/
    /*Shape of envelope: 0x08, Sustain: 0x2100*/
    {rest, 55},
    ...
    /*16th */
    {B >> fourth_oct, 7}, {rest, 13}, {D >> fifth_oct, 13}, {rest, 13},
    /***CHANGE OF ENVELOPE. Shape: , Sustain: ***/
    ...
    /*20th bar*/
    /*NOTE: idea to change the two rest of 13 sec each to a C#6 and C6 respectively*/
    ...
    /*24th bar*/
    {D >> sixth_oct, 7}, {rest, 1}, {D >> sixth_oct, 13}, {rest, 13}, {rest, 13},
    /***CHANGE OF ENVELOPE. shape: 0x08, Sustain: 0x2100***/
    ...
    {C_sharp >> sixth_oct, 13}, 
    /***CHANGE OF ENVELOPE. shape: , Sustain: 0x***/
    {G_sharp >> fifth_oct, 13}, {rest, 6}, {F_sharp >> fifth_oct, 13},
    {rest, 6}, {E >> fifth_oct, 13}, {F_sharp >> fifth_oct, 7},
...
void startMusic(char title)
{
    ...
    {
        enableChannel(channelB, 1, 0);
        setTone(channelB, gameSong[curNote].pitch);
        setVolume(channelB, 0x0f);
    }
